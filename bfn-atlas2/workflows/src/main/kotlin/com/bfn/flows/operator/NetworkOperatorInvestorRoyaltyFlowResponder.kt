...
class NetworkOperatorInvestorRoyaltyFlowResponder(private val counterPartySession: FlowSession) : FlowLogic<SignedTransaction>() {
    ...
    override fun call(): SignedTransaction {
       Companion.logger.info("${Em.RED_APPLES} " +
               "NetworkOperatorInvestorRoyaltyFlowResponder starting ....")
        val myself = serviceHub.ourIdentity
        val party = counterPartySession.counterparty

        Companion.logger.info("${Em.RED_APPLES} \" NetworkOperatorInvestorRoyaltyFlowResponder: " +
        ...
        Companion.logger.info("${Em.RED_APPLES} \"  " +
                "NetworkOperatorInvestorRoyaltyFlowResponder Transaction finalized " +
    ...
    companion object {
        private val logger = LoggerFactory.getLogger(NetworkOperatorInvestorRoyaltyFlowResponder::class.java)
    }
