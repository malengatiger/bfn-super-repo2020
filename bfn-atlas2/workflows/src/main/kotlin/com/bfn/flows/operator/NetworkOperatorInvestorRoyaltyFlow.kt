...
@InitiatingFlow
@StartableByRPC
class NetworkOperatorInvestorRoyaltyFlow(private val supplierPaymentId: String ) : FlowLogic<SignedTransaction>() {

    @Suspendable
    override fun call(): SignedTransaction {
        Companion.logger.info(pp + "NetworkOperatorInvestorRoyaltyFlow started, name: $supplierPaymentId" )
...
//        txBuilder.addOutputState(networkOperatorState)
        ...
        Companion.logger.info("$pp Yebo Gogo!! - NetworkOperatorInvestorRoyaltyFlow: $supplierPaymentId $pp")
        return tx
    }

    private val pp = "\uD83E\uDD95 \uD83E\uDD95 \uD83E\uDD95 \uD83E\uDD95";
    companion object {
        private val logger = LoggerFactory.getLogger(NetworkOperatorInvestorRoyaltyFlow::class.java)
    }
