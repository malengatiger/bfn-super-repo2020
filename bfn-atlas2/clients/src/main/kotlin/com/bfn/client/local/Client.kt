...
//        setupLocalNodes()
//        startTheWork( "http://localhost:10050", "http://localhost:10053", false);
//
//    }
//
//    fun startTheWork(networkOperatorUrl: String, customerUrl: String, delete: Boolean) {
//        if (delete) {
////            FirebaseUtil.deleteBFNAnchor();
////            FirebaseUtil.deleteCustomers();
//        }
//        createNetworkOperator(networkOperatorUrl, false)
//
//        createCustomer(customerUrl)
//        startSupplierAccounts(
//                numberOfAccounts = 12,
//                url = networkOperatorUrl);
//        letsDance(networkOperatorUrl)
//    }
//
