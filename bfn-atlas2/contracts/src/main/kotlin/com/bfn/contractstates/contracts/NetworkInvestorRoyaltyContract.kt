...
class NetworkInvestorRoyaltyContract : Contract {
    @Throws(IllegalArgumentException::class)
    override fun verify(tx: LedgerTransaction) {
        logger.info("\uD83D\uDD06 NetworkInvestorRoyaltyContract: verify starting" +
                " ..... \uD83E\uDD6C \uD83E\uDD6C ")
...
//        }
    ...
    companion object {
        ...
        private val logger = LoggerFactory.getLogger(NetworkInvestorRoyaltyContract::class.java)
    }
}
