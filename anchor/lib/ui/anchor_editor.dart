...
class _AnchorEditorState extends State<AnchorEditor> {
  ...
  initState() {
    ...
    if (widget.anchor != null) {
      debugPrint(
          '😝 😝 initializing form with anchor details 😝 ${widget.anchor.toJson()}  😝 ');
      ...
      minInvoiceEditor.text = '200000.00';
      maxInvoiceEditor.text = '3500000.00';
      maxInvestmentEditor.text = '100000000.00';
      tradeFreqEditor.text = '120';
      defaultDiscEditor.text = '6.8';
                        ...
                        child: Column(children: <Widget>[
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText: 'Cellphone',
                              hintText:
                                  'Enter Cellphone with country code prefix',
                              border: OutlineInputBorder(),
                            ),
                            validator: (value) {
                              if (value.isEmpty) {
